...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = higher_education[higher_education['salary'] == '>50K'].count().salary / df.education.count()
    lower_education_rich = lower_education[lower_education['salary'] == '>50K'].count().salary / df.education.count()
